...
pub fun main () : {String: AnyStruct} {
	...
	let flowUnits = PonsUtils .FlowUnits (100.0, "FUSD")
	...
	let pass =
		pureScaling
		&& (flowUnitsScaled1 .flowAmount == PonsUtils .FlowUnits (20.0, "FUSD") .flowAmount)
		&& (flowUnitsScaled2 .flowAmount == PonsUtils .FlowUnits (2.0, "FUSD") .flowAmount)
