...
, testInfo : {String: String}
	...
	prepare (ponsAccount : AuthAccount, artistAccount : AuthAccount, randomAccount : AuthAccount) {
		...
		PonsUsage .submitEscrow (
			...
			id: "consummation-test-transaction-14-random",
		...
		PonsUsage .submitEscrow (
			...
			id: "consummation-test-transaction-14-artist",
			heldResourceDescription: PonsEscrowContract.EscrowResourceDescription (
				flowUnits: PonsUtils.FlowUnits (0.0, "FUSD"),
				ponsNftIds: [] ),
			requirement: PonsEscrowContract.EscrowResourceDescription (
		...
		escrowManagerRef .dismissEscrow (id: "consummation-test-transaction-14-random")
		escrowManagerRef .dismissEscrow (id: "consummation-test-transaction-14-artist")
