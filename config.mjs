...
const FLOW_TUNNEL_PROXY_ADDRESS = ""
...
const FLOW_MARKET_TRANSFER_EVENT = ""
const FLOW_USER_TRANSFER_EVENT = ""
const POLYGON_FUSD_MARKET_TRANSFER_EVENT = "nftSentThroughTunnelForMarket_fusd"
const POLYGON_FLOW_MARKET_TRANSFER_EVENT = "nftSentThroughTunnelForMarket_flow"
const POLYGON_FLOW_USER_TRANSFER_EVENT = "nftSentThroughTunnel"
...
export { CHILD_TUNNEL_PROXY_ADDRESS, ROOT_TUNNEL_PROXY_ADDRESS, CHILD_FX_TOKEN_PROXY_ADDRESS, ROOT_FX_TOKEN_PROXY_ADDRESS, CHILD_PROXY_ADMIN_ADDRESS, ROOT_PROXY_ADMIN_ADDRESS, FX_MANAGER_PROXY_ADDRESS, FLOW_MARKETPLACE_ADDRESS, POLYGON_MARKETPLACE_ADDRESS, FLOW_TUNNEL_PROXY_ADDRESS }
export { BASE_TOKEN_URI, FLOW_MARKET_TRANSFER_EVENT, FLOW_USER_TRANSFER_EVENT, POLYGON_FUSD_MARKET_TRANSFER_EVENT, POLYGON_FLOW_MARKET_TRANSFER_EVENT, POLYGON_FLOW_USER_TRANSFER_EVENT }
