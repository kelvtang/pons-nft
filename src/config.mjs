import { v4 } from 'uuid'
import * as flow_sdk_api from '@onflow/sdk'
...
let access_node_origin = /**/'http://localhost:8888'//'http://lvh.me:8888'//'https://rest-testnet.onflow.org'//'https://rest-mainnet.onflow.org'/**/
